          ...
          >
            ...
            >
              <MdOutlineClose
                ...
                className="text-3xl text-green-500 cursor-pointerhover:tex-red-500 absolute
                top-4 right-4"
              />
            ...
            hover:text-green-700  duration-300 px-2 py-1 text-xl mb-4"
              ...
              <motion.a
                ...
                className="text-sm w-72 tracking-widest hover:text-green-500 text-center mt-4"
                href=""
              >
                ozanocak@gmail.com
              </motion.a>
